...
// 🌍 Adjust Popup Size Dynamically for Mobile
function adjustPopupSize() {
    ...
    popups.forEach(popup => {
        ...
        popup.style.width = "90%"; // Adjust width dynamically
        popup.style.borderRadius = "15px"; // Softer design
    });
}

// 🔄 Run on Resize and Page Load
